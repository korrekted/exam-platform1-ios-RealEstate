...
final class GlobalDefinitions {
    ...
    static let apiKey = "5LBaYgwx4ciqjyD2"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "rgIOj1dwfwBHZlen"

    static let applicationTag = "EXAM_REAL_ESTATE"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/real-estate-express-exam-prep/id1559966609"
    static let appleAppID = "1559966609"
