...
private extension PaygateOptionView {
    ...
    func updateColors() {
        ...
        layer.borderColor = isSelected ? UIColor(integralRed: 237, green: 86, blue: 114).cgColor : UIColor.black.cgColor
        ...
        saveLabel.backgroundColor = UIColor(integralRed: 237, green: 86, blue: 114)
    }
}
