...
private extension PaygateOptionView {
    ...
    func updateColors() {
        ...
        layer.borderColor = isSelected ? UIColor(integralRed: 255, green: 115, blue: 99).cgColor : UIColor.black.cgColor
        ...
        saveLabel.backgroundColor = UIColor(integralRed: 255, green: 115, blue: 99)
    }
}
